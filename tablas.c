...
void crearBD(){
    ...
    char *sql1 = "Create table if not exists USUARIO ("
                "DNI varchar primary key not null,"
                "nombre varchar not null,"
                "apellido varchar not null,"
    ...
    char *sql2 = "Create table if not exists TIPO_COMIDA ("
    ...
    char *sql5 = "Create table if not exists RESERVA_HOTEL ("
    ...
    char *sql7 = "Create table if not exists RESERVA_COMEDOR ("
